...
module x_end_holes() {
  ...
  translate(v=[0, -17, 0]) rotate([0, 0, -135]) translate([0, tr_nut_distance/2, -1]) cylinder(h=2, r1=2.2, r2=1.65, $fn=50);
  translate(v=[0, -17, 0]) rotate([0, 0, -135]) translate([0, -tr_nut_distance/2, -1]) cylinder(h=2, r1=2.2, r2=1.65, $fn=50);

  // Nut traps for TR nut screws
  translate(v=[0, -17, 0]) rotate([0, 0, -135]) translate([0, tr_nut_distance/2, 11]) rotate([0, 0, 0]) cylinder(h=6, r=3.15, $fn=6);
  translate(v=[0, -17, 0]) rotate([0, 0, -135]) translate([0, -tr_nut_distance/2, 10]) rotate([0, 0, 30]) cylinder(h=3, r=3.1, $fn=6);
